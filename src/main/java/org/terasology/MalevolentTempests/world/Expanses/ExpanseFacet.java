...
/*
 * This facet uses a 2D field for ease of spawning expanses above any place marked -1, -2, -3 in field.
 * Expanses can be of two types: empty, thin-cloud (Same as empty except there is thick cloud there, not air), lightning
